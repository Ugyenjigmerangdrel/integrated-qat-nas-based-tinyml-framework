...
train_loss, train_acc, val_loss, val_acc, test_loss, test_acc = train_qat_model(model, opt, X_train, y_train, X_val, y_val, X_test, y_test, "./models/rs/best_rs_qat_dscnn.weights.h5", "./models/best_rs_qat_dscnn.keras")
